...
### Documentation
- README, wiki Getting-Started, and wiki Troubleshooting now document hard dependencies (zsh, git, curl, Homebrew) separately from auto-installed packages, and include a new "`ll` shows `?` boxes" troubleshooting entry.
